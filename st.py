...
if alerta:
    ...
    texto = "⚠️ALERTA⚠️ programando alertas: aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    tiempo_animacion = max(10, len(texto) * 0.5)

    st.markdown(
        f"""
        <div style="width:100%;height:150px;background:red;overflow:hidden;position:relative;animation: blink 1.3s infinite;
                    display:flex; align-items:center;">
            <div style="display:inline-block; white-space:nowrap; animation: scrollText {tiempo_animacion}s linear infinite; font-size:30px; color:white;">
